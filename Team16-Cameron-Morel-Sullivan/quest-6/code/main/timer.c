...
void alarm_init() 
{
  ...
  // Configure the alarm value and the interrupt on alarm (use 1s)
  // For 100ms --> TIMER_INTERVAL_100_MS * TIMER_SCALE_MS
  timer_set_alarm_value(TIMER_GROUP_0, TIMER_0, TIMER_INTERVAL_SEC * TIMER_SCALE_SEC);
